    ...
    <div className="min-h-screen bg-black text-white flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10 my-8">
        <div className="text-center mb-8">
          <img src="/logo.png" alt="Cardixx Logo" className="w-24 h-24 mx-auto object-contain drop-shadow-[0_0_20px_rgba(168,85,247,0.3)] mb-6" />
          <h1 className="text-3xl font-bold font-mono tracking-tighter mb-2">Create Account</h1>
          <p className="text-zinc-400">Join Cardixx and build your digital identity</p>
        </div>
