    ...
    <div className="min-h-screen bg-black text-white flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-10">
          <img src="/logo.png" alt="Cardixx Logo" className="w-24 h-24 mx-auto object-contain drop-shadow-[0_0_20px_rgba(59,130,246,0.3)] mb-6" />
          <h1 className="text-3xl font-bold font-mono tracking-tighter mb-2">Welcome to Cardixx</h1>
